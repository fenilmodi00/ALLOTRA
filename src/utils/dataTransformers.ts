...
export const transformIPOData = (ipo: IPO | IPOWithGMP): DisplayIPO => {
  ...
  const transformed: DisplayIPO = {
    ...
    dates: {
      open: ipo.open_date || null,
      close: ipo.close_date || null,
      allotment: ipo.result_date || null,
      listing: ipo.listing_date || null,
    },
    lotSize: ipo.min_qty || 0,
    minInvestment: ipo.min_amount || 0,
    registrar: ipo.registrar || 'Unknown',
    logoUrl: ipo.logo_url || null,
    category,
    issueSize: ipo.issue_size || null,
    subscriptionStatus: ipo.subscription_status || null,
    listingGain: ipo.listing_gain || null,
    description: ipo.description || null,
    about: ipo.about || null,
  ...
  if ('gmp_value' in ipo && ipo.gmp_value !== undefined) {
    transformed.gmp = {
      ...
      lastUpdated: ipo.gmp_last_updated || null,
      subscriptionStatus: ipo.gmp_subscription_status || null,
      listingGain: ipo.gmp_listing_gain || null,
      dataSource: ipo.gmp_data_source || null,
    }
  }
