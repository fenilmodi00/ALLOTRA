      ...
      >
        <ScrollView contentContainerStyle={styles.scrollContainer}>
          <View style={styles.content}>
            <Text style={styles.title}>Sign in to SO</Text>
...
const styles = StyleSheet.create({
  ...
  title: {
    ...
    marginBottom: 40,
    textAlign: 'center',
    fontFamily: 'Work Sans', // Note: Make sure this font is loaded in your project
  },
  socialButton: {
  ...
  signUpText: {
    ...
    fontSize: 18,
    textAlign: 'center',
    fontFamily: 'Plus Jakarta Sans', // Note: Make sure this font is loaded in your project
  },
}); 